...
| Type | Project | Desc |
| --- | --- | --- |
| ![app][icon-app] | [Table Habit][Table Habit] | ![stars](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fungh.cc%2Frepos%2FFriesI23%2Fmhabit&query=%24.repo.stars&label=stars&style=flat-square) [![release](https://img.shields.io/github/v/release/FriesI23/mhabit?style=flat-square)](https://github.com/FriesI23/mhabit/releases) [![F-Droid downloads](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fgithub.com%2Fkitswas%2Ffdroid-metrics-dashboard%2Fraw%2Frefs%2Fheads%2Fmain%2Fprocessed%2Ftotal%2Fio.github.friesi23.mhabit.json&query=%24.total_downloads&logo=fdroid&label=downloads&style=flat-square)](https://f-droid.org/packages/io.github.friesi23.mhabit/) |
| ![dart][icon-dart] | [Dart Transmission Rpc][Dart Transmission Rpc] | [![pub](https://img.shields.io/pub/v/dart_transmission_rpc?style=flat-square)](https://pub.dev/packages/dart_transmission_rpc) [![likes](https://img.shields.io/pub/likes/dart_transmission_rpc?style=flat-square)](https://pub.dev/packages/dart_transmission_rpc) ![downloads][dl-dart_transmission_rpc] ![stars](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fungh.cc%2Frepos%2FFriesI23%2Fdart_transmission_rpc&query=%24.repo.stars&label=stars&style=flat-square) |
| ![dart][icon-dart] | [Simple Heatmap Calendar][Simple Heatmap Calendar] | [![pub](https://img.shields.io/pub/v/simple_heatmap_calendar?style=flat-square)](https://pub.dev/packages/simple_heatmap_calendar) [![likes](https://img.shields.io/pub/likes/simple_heatmap_calendar?style=flat-square)](https://pub.dev/packages/simple_heatmap_calendar) ![downloads][dl-simple_heatmap_calendar] ![stars](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fungh.cc%2Frepos%2FFriesI23%2Fsimple_heatmap_calendar&query=%24.repo.stars&label=stars&style=flat-square) |
| ![dart][icon-dart] | [Simple WebDAV Client][Simple WebDAV Client] | [![pub](https://img.shields.io/pub/v/simple_webdav_client?style=flat-square)](https://pub.dev/packages/simple_webdav_client) [![likes](https://img.shields.io/pub/likes/simple_webdav_client?style=flat-square)](https://pub.dev/packages/simple_webdav_client) ![downloads][dl-simple_webdav_client] ![stars](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fungh.cc%2Frepos%2FFriesI23%2Fsimple_webdav_client&query=%24.repo.stars&label=stars&style=flat-square) |
| ![dart][icon-dart] | [Named HTTP Color][Named HTTP Color] | [![pub](https://img.shields.io/pub/v/named_html_color?style=flat-square)](https://pub.dev/packages/named_html_color) [![likes](https://img.shields.io/pub/likes/named_html_color?style=flat-square)](https://pub.dev/packages/named_html_color) ![downloads][dl-named_html_color] ![stars](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fungh.cc%2Frepos%2FFriesI23%2Fnamed_html_color&query=%24.repo.stars&label=stars&style=flat-square) |
...
| ![github][icon-github] | [HomeBrew Repo][HomeBrew Repo] | [![cask](https://img.shields.io/github/directory-file-count/FriesI23/homebrew-brew-repo/Casks?type=file&extension=rb&style=flat-square&color=fbb040&label=cask)][HomeBrew Tap Site] [![cask-third-party](https://img.shields.io/github/directory-file-count/FriesI23/homebrew-brew-repo/Casks/third-party?type=file&extension=rb&style=flat-square&color=fbb040&label=cask-third-party)][HomeBrew Tap Site] [![third-party](https://img.shields.io/static/v1?label=third-party&message=penpot-desktop%20%7C%20wireguard%20%7C%20...&color=lightgrey&style=flat-square)][HomeBrew Tap Site] |
| ![github][icon-github] | [Flathub Repo - Table Habit][Flathub Repo - Table Habit] | [![flathub](https://img.shields.io/flathub/v/io.github.friesi23.mhabit?style=flat-square)](https://flathub.org/apps/io.github.friesi23.mhabit) |
| ![github][icon-github] | [Scoop Bucket][Scoop Bucket] | [![apps](https://img.shields.io/github/directory-file-count/FriesI23/scoop-bucket/bucket?type=file&extension=json&style=flat-square&label=apps)][Scoop Bucket] |
| ![docs][icon-docs] | [RPC4918 CN][RPC4918 CN] | ![stars](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fungh.cc%2Frepos%2FFriesI23%2Frfc4918-cn&query=%24.repo.stars&label=stars&style=flat-square) [![gitbook][icon-gitbook]][RFC4918 CN Site] |
| ![actions][icon-actions] | [Honkit Build Page][Honkit Build Page] | ![stars](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fungh.cc%2Frepos%2FFriesI23%2Fhonkit-build-page&query=%24.repo.stars&label=stars&style=flat-square) [![marketplace][icon-marketplace]][Honkit Build Page Marketplace] |
| ![actions][icon-actions] | [Homebrew Bump Cask Plus][Homebrew Bump Cask Plus] | ![stars](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fungh.cc%2Frepos%2FFriesI23%2Faction-homebrew-bump-cask&query=%24.repo.stars&label=stars&style=flat-square) [![marketplace][icon-marketplace]][Homebrew Bump Cask Plus Marketplace] |
...
[icon-altstore]: https://img.shields.io/badge/AltStore-FF5A5F?style=flat-square
[icon-sidestore]: https://img.shields.io/badge/SideStore-0A84FF?style=flat-square
[icon-docs]: https://img.shields.io/badge/-000000?style=flat-square&logo=markdown&logoColor=white
[icon-gitbook]: https://img.shields.io/badge/GitBook-7B36ED?style=flat-square&logo=gitbook&logoColor=white
[icon-actions]: https://img.shields.io/badge/-2088FF?style=flat-square&logo=githubactions&logoColor=white
[icon-marketplace]: https://img.shields.io/badge/Marketplace-2088FF?style=flat-square&logo=githubactions&logoColor=white

<!-- downloads -->

[dl-dart_transmission_rpc]: https://img.shields.io/badge/dynamic/json?url=https://pub.dev/api/packages/dart_transmission_rpc/score&label=downloads&query=%24.downloadCount30Days&style=flat-square
[dl-simple_heatmap_calendar]: https://img.shields.io/badge/dynamic/json?url=https://pub.dev/api/packages/simple_heatmap_calendar/score&label=downloads&query=%24.downloadCount30Days&style=flat-square
[dl-simple_webdav_client]: https://img.shields.io/badge/dynamic/json?url=https://pub.dev/api/packages/simple_webdav_client/score&label=downloads&query=%24.downloadCount30Days&style=flat-square
[dl-named_html_color]: https://img.shields.io/badge/dynamic/json?url=https://pub.dev/api/packages/named_html_color/score&label=downloads&query=%24.downloadCount30Days&style=flat-square
...
[RFC4918 CN Site]: https://friesi23.github.io/rfc4918-cn/
[Honkit Build Page]: https://github.com/FriesI23/honkit-build-page
[Honkit Build Page Marketplace]: https://github.com/marketplace/actions/honkit-build-page
[Homebrew Bump Cask Plus]: https://github.com/FriesI23/action-homebrew-bump-cask
[Homebrew Bump Cask Plus Marketplace]: https://github.com/marketplace/actions/homebrew-bump-cask-plus
...
[HomeBrew Tap Site]: https://brew-repo.friesi23.icu/
